...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final GraphPoet cool  = new GraphPoet(new File("src/P1/poet/Dylan Thomas.txt"));
        final String coolinput = "What I do know is your tears go into night.";
        System.out.println(coolinput + "\n>>>\n" +cool.poem(coolinput));
    }
